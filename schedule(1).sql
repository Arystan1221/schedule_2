...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 22 2022 г., 01:36
...
(1, 'Ис-20-12б', 1, '2020-09-01', '2024-07-01'),
(2, 'П-20-51б', 5, '2020-09-01', '2024-07-01'),
(3, 'Т-20-1212К', 2, '2021-12-07', '2024-12-31'),
(4, 'Л-19-6гб', 4, '2020-09-01', '2023-07-01');
...
(1, 'Web-программирование', 1, 96, 1),
(2, 'Строительство', 3, 105, 1);
...
(2, 'Arystan', 'Abdenov', 'Nurzhanovich', 'arysadmin', '1234', 1, '2004-01-03', 3, 1),
(3, 'Джонатан', 'Джозеф', 'Джозефович', 'jonathan1234', '$2y$10$HvTlzjeBPdtHdVRwGT0ZZuANH61Y8j6SdFUEL3iWGfHnNu4/MltQ.', 1, '1990-07-11', 3, 1),
(4, 'Альжанова', 'Дарига', '', 'dariga', '$2y$10$zVt7DaGQbmav4F4NwEahFO44r/E9Tk0wbQHMQTf.21BYZpy.wMZoe', 2, '2002-11-05', 4, 1),
(5, 'Грановский', 'Сергей', 'Леонтьевич', 'sergey', '$2y$10$3qfkpwauWETy702DyeDhVuh.wFt8DC42X92H.AIL8.V7vFjpVk53W', 1, '2002-10-29', 3, 1),
(6, 'Иванов', 'Иван', 'Иванович', 'ivan', '$2y$10$CAWIzWD3CVvD6PLOkiBsL.4qG9sDgbPQ6CXwSlHqJDGYxTJ8/ukBq', 1, '1994-03-16', 3, 1),
(7, 'Man', 'Helmen', NULL, 'manager', '$2y$10$mFlJsQgNvDQ27XfADrMh8O9OQA47f2gLmqYdwGeg8SpsvdoRUX95S', 1, '2001-02-20', 2, 1);
...
--
ALTER TABLE `schedule`
  ADD CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`lesson_plan_id`) REFERENCES `lesson_plan` (`lesson_plan_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
